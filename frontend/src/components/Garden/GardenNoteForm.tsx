...
import { LifeLogEntry } from '../LifeLog/LifeLogView';
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              {Object.values(GrowthStage).map(stage => {
                ...
                return (
                  <button
                    ...
                    className={`p-4 rounded-lg border-2 transition-all duration-200 hover:scale-105 active:scale-95 ${isSelected
          ...
          <div>
            ...
            <textarea
              ...
              rows={8}
              className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-vertical ${errors.content ? 'border-red-500' : 'border-gray-300'
                }`}
