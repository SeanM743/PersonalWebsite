@echo off
REM Personal Dashboard Environment Setup Script for Windows

echo 🚀 Setting up Personal Dashboard environment variables...

REM Finnhub API Key (already configured)
set FINNHUB_API_KEY=d56snvhr01qkvkasbedgd56snvhr01qkvkasbee0
echo ✅ Finnhub API key configured

REM Google Calendar credentials path
set GOOGLE_CALENDAR_CREDENTIALS_PATH=C:\Users\seanm\.config\google\google-calendar-credentials.json
echo ✅ Google Calendar credentials path set

REM Create the credentials directory if it doesn't exist
if not exist "C:\Users\seanm\.config\google\" mkdir "C:\Users\seanm\.config\google\"
